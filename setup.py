...
''')
        self.announce(f'Finished compiling {self.sparse_utils_cpp_location}.', level=distutils.log.INFO)
        return
...
cmdclass = {'compile_sparse_utils_so': CompileSparseUtilsSharedObjectCommand,}
